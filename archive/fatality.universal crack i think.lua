                ...
                if please_load then
                    do
                        (function() -- src/Lua/Scripts/da_hood/things.lua
                            ...
                            -- hahahaha, actually did this due to me being lazy to do something like player.Character in getnearestplayertomouse so I did this little shit ðŸ˜€ðŸ˜€
                            ...
                            function da_hood.functions:camera_aim(arguments)
                            	...
                            	-- too much things in arguments ðŸ˜
                            	...
                            	-- pov, you avoid else in if statements ðŸ¤£ðŸ¤£ðŸ¤£
                    ...
                    do -- src/Lua/Scripts/da_hood/components/
                        do -- src/Lua/Scripts/da_hood/components/a_aimassist.lua
                            -- THIS SHIT IS ACTUALLY P!112!!!! ðŸ˜±ðŸ˜±ðŸ˜±
                                ...
                                if type(bone) == "table" and #bone > 0 then
                                    if closest_mode ~= "none" then
                                        if closest_mode == "closest part" then
                                            ...
                                            if type(newBone) == "string" and newBone ~= "" and character:FindFirstChild(newBone) then -- very superior check ðŸ˜Ž could do a better one but meh
                                ...
                                if type(bone) == "table" and #bone > 0 then
                                    if closest_mode ~= "none" then
                                        if closest_mode == "closest part" then
                                            ...
                                            if type(newBone) == "string" and newBone ~= "" and silentaim.character:FindFirstChild(newBone) then -- very superior check ðŸ˜Ž could do a better one but meh
                        ...
                        do -- src/Lua/Scripts/da_hood/components/f_settings.lua
                            ...
                            NOTE:Label("THIS SECTION IS STILL IN DEVELOPMENT ðŸ”¨")
                            ...
                            if type(bone) == "table" and #bone > 0 then
                                if closest_mode ~= "none" then
                                    if closest_mode == "closest part" then
                                        ...
                                        if type(newBone) == "string" and newBone ~= "" and aimassist.character:FindFirstChild(newBone) then -- very superior check ðŸ˜Ž could do a better one but meh
